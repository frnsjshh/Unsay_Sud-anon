        ...
        <body class="bg-gradient-to-br from-[#FAFAF8] to-[#F5F5F3] min-h-screen flex items-center justify-center p-4">
            ...
            <div class="w-full max-w-4xl bg-white rounded-3xl shadow-xl overflow-hidden">
                ...
                <div class="p-8 md:p-12">
                    ...
                    <!-- Autosuggest Datalist -->
                    <datalist id="ingredientsList">
                        <c:forEach items="${applicationScope.allIngredients}" var="ing">
                            <option value="${ing}">
                        </c:forEach>
                    </datalist>

                    <!-- Input Form -->
                    <form action="recipes" method="post" class="mb-8">
                        ...
                        <div class="flex flex-col md:flex-row gap-4">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex gap-2">
                                    <input type="text" name="ingredient" list="ingredientsList"
                                        placeholder="e.g. Pork, Vinegar"
                                        ...
                                        autofocus>
                                    <button type="submit"
                                        class="bg-[#141413] text-white px-6 py-4 rounded-xl font-semibold hover:bg-gray-800 transition-colors">
                                        Add
                                    </button>
                                </div>
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <c:forEach items="${sessionScope.userIngredients}" var="ing">
                                        <div
                                            class="bg-white border border-gray-200 shadow-sm px-4 py-2 rounded-full flex items-center gap-2 text-[#475467]">
                                            <span>${ing}</span>
                    ...
                    <div class="flex flex-col gap-4">
                        <c:set var="ingCount"
                            value="${empty sessionScope.userIngredients ? 0 : sessionScope.userIngredients.size()}" />

                        <form action="recipes" method="post" class="space-y-4">
                            <input type="hidden" name="action" value="search">

                            <!-- Category Filter -->
                            <div class="flex items-center gap-4 bg-gray-50 p-4 rounded-xl">
                                <label class="font-medium text-gray-700">Filter by Category:</label>
                                <select name="category"
                                    class="bg-white border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:border-[#D17557]">
                            ...
                            <button type="submit"
                                ...
                                ${ingCount < 1 ? 'disabled title="Add at least 1 ingredient"' : '' }>
                                Find Recipes
                            </button>
                        </form>
